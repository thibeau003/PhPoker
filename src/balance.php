...
<body class="bg-slate-700">
    ...
    <div class="pt-20">
        ...
        <div class="bg-slate-800 mt-6 rounded-xl w-1/3 mx-auto text-center text-white">
            ...
            } else if (isset($_POST['withdraw_amount'])) {
                ...
                if (isset($_GET["action"]) && $_GET["action"] == "withdraw") {
                    ...
                    <form action='' method='post'>  
                        <div class='w-1/2 mx-auto'>
                            ...
                            <br>
                            <input class='text-center w-full bg-transparent border-b-2 mb-4 border-slate-700 focus:outline-none' type='amount' id='withdraw_amount' name='withdraw_amount' required>
                        </div>
                        
                        <input type='submit' class='w-1/2 bg-slate-900 rounded-full mb-4' value='Withdraw'>
                    </form>
                ";
                } else {
                    echo "
